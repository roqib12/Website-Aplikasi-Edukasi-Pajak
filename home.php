...
<head>
    <title>Dashboard | Tax Center</title>
    <meta charset="utf-8">
                ...
                <div class="card pt-0 mt-0 pb-0 py-1">
                    <div class="container-fluid">
                        ...
                        <div class="dashboard-content mb-5">
                            <h4 style="text-align: center;"><strong>Selamat Datang di Tax Center Politeknik Negeri Batam</strong></h4>
                            <br>
                            <ol>
                                <li>
                                    Lihat / Ubah Data Pribadi
                                </li>
                                <li>
                                    Melakukan Pendataan Karyawan
                                </li>
                                <li>
                                    Melakukan Perhitungan Pajak PPh 21
                                </li>
                                <li>
                                    Melihat Panduan Penggunaan Edukasi Pajak
                                </li>
                                <br>
