                ...
                <div class="card pt-0 mt-0 pb-0 py-1">
                    <div class="container-fluid">
                        ...
                        <div class="col-md-12 p-4">
                            <form action="prosesAddPengguna.php" method="POST">
                                <div class="row">
                                    <div class=" col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="row py-4">
                                            <div class="col-6">
                                                <input type="submit" class="btn bg-success text-white" title="Simpan" value="Simpan">
                                                </input>
                                            </div>
                                            <div class="col-6">
                                                <input type="button" class="btn bg-success text-white" title="Batal" style="width:100%;" value="Batal" onclick="history.back(-1)" onclick="history.back(-1)"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
